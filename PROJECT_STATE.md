...
### Result
IONEX at standard resolution cannot verify 239 m/s:
...
### Speed still unverified
Needs raw GPS receiver TEC at 1-30 sec cadence (MIT Haystack Madrigal
instrument 8000 — Jan 2026 not yet ingested). Check in 6-12 months.

### Open items
1. Send Gwyn email
2. Run find_event_stations.py for cross-validation DOA
3. Check Madrigal in 6-12 months for Jan 2026 GPS TEC
